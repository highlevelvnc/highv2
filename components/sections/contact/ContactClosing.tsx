...
export default function ContactClosing() {
  return (
    <Section bg="secondary" id="contact-closing" className="!overflow-visible">
      <Container>
        <ScrollReveal variants={scaleIn}>
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated px-8 py-16 text-center sm:px-16 sm:py-20">
            ...
            >
              ...
              <h2 className="mb-5 font-display text-[clamp(28px,5vw,52px)] font-bold leading-[1.1] tracking-[-0.03em] text-text-primary">
                See the work first.
              </h2>

              <p className="mx-auto mb-10 max-w-md font-body text-[15px] leading-relaxed text-text-secondary">
                Browse our case studies before reaching out. Every engagement we
                take on is featured — no cherry-picking, no vanity metrics.
              </p>
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                ...
                <Button variant="secondary" size="lg" asChild>
                  <Link href="/#social-proof">Read Testimonials</Link>
                </Button>
              </div>
            </motion.div>
          </div>
