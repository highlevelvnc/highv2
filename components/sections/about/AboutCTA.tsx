...
export default function AboutCTA() {
  return (
    <Section bg="primary" id="about-cta" className="!overflow-visible">
      <Container>
        <ScrollReveal variants={scaleIn}>
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated px-8 py-16 text-center sm:px-16 sm:py-20">
            ...
            <motion.div
              ...
              className="relative"
            >
              <p className="mb-4 font-mono text-[11px] uppercase tracking-[0.14em] text-accent-primary">
                Work with us
              </p>

              <h2 className="mb-5 font-display text-[clamp(28px,5vw,56px)] font-bold leading-[1.06] tracking-[-0.03em] text-text-primary">
              ...
              <p className="mx-auto mb-10 max-w-md font-body text-[15px] leading-relaxed text-text-secondary">
                ...
                exactly what infrastructure it needs — and whether we&apos;re
                the right fit to build it.
              </p>
