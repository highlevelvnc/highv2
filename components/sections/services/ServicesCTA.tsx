...
export default function ServicesCTA() {
  return (
    <Section bg="primary" id="services-cta" className="!overflow-visible">
      <Container>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated px-8 py-16 text-center sm:px-16 sm:py-20">
            ...
            >
              ...
              <p className="mx-auto mb-10 max-w-md font-body text-[15px] leading-relaxed text-text-secondary">
                A 30-minute discovery call is enough to identify the right starting
                point and understand whether we are the right fit for where you want
                to go.
              </p>
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                ...
                <Button variant="secondary" size="lg" asChild>
                  <Link href="/work">See the Work First</Link>
                </Button>
              </div>
            </motion.div>
          </div>
