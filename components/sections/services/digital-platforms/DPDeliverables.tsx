...
import { deliverables } from '@/lib/data/service-pages/digital-platforms'

export default function DPDeliverables() {
  return (
    <Section bg="primary" id="dp-deliverables">
      <Container>
        {/* Header */}
        <div className="mb-14 max-w-2xl">
          ...
          <ScrollReveal delay={0.14}>
            <p className="mt-5 font-body text-[16px] leading-relaxed text-text-secondary">
              Every deliverable is defined by the outcome it produces — not the technology it
              uses. We build the platform that the growth strategy actually needs.
            </p>
          </ScrollReveal>
        </div>
          ...
          {deliverables.map((d) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(90deg, #0EA5E9 0%, #6C3AFF 100%)',
                }}
                aria-hidden="true"
              />
