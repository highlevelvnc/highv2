...
import { problems } from '@/lib/data/service-pages/digital-platforms'

export default function DPProblems() {
  return (
    <Section bg="secondary" id="dp-problems">
      <Container>
        {/* Header */}
        <div className="mb-14 max-w-2xl">
          <ScrollReveal>
            <SectionLabel withLine className="mb-5">
              Where most digital experiences fail
            </SectionLabel>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.14}>
            <p className="mt-5 font-body text-[16px] leading-relaxed text-text-secondary">
              Platform problems are rarely design problems. They are conversion problems,
              clarity problems, and architecture problems. These are the failure modes
