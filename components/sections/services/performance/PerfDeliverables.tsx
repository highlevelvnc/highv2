...
import { deliverables } from '@/lib/data/service-pages/performance'

export default function PerfDeliverables() {
  return (
    <Section bg="primary" id="perf-deliverables">
      <Container>
        <div className="mb-14 max-w-2xl">
          ...
          <ScrollReveal delay={0.08}>
            <h2 className="font-display text-[clamp(30px,4.5vw,52px)] font-bold leading-[1.1] tracking-[-0.03em] text-text-primary">
              ...
              >
                and the return each part produces.
              </span>
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.14}>
            <p className="mt-5 font-body text-[16px] leading-relaxed text-text-secondary">
              Every component of the performance layer is connected to a measurable
              business outcome. We do not manage channels in isolation — we build a
              system where each part makes the others more effective.
            </p>
          </ScrollReveal>
        </div>
