...
import { fitProfiles } from '@/lib/data/service-pages/performance'

export default function PerfFit() {
  return (
    <Section bg="primary" id="perf-fit">
      <Container>
          ...
          <div>
            ...
            <ScrollReveal delay={0.08}>
              <h2 className="mb-5 font-display text-[clamp(28px,4vw,48px)] font-bold leading-[1.1] tracking-[-0.03em] text-text-primary">
                ...
                >
                  that want acquisition clarity.
              </span>
            </h2>
            </ScrollReveal>
            <ScrollReveal delay={0.14}>
              <p className="font-body text-[15px] leading-relaxed text-text-secondary">
                Performance works best when there is already some acquisition activity to
                work with — whether that is paid, organic, or both. The goal is always
                the same: make every pound spent produce a measurable, auditable return.
              </p>
            </ScrollReveal>
          </div>
          ...
          <div className="mt-16 rounded-2xl border border-border-subtle bg-bg-elevated px-8 py-7">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:gap-6">
              <p className="shrink-0 font-mono text-[10px] uppercase tracking-[0.14em] text-text-muted sm:pt-1">
                Is Performance the right starting point?
              </p>
              <p className="font-body text-[14px] leading-relaxed text-text-secondary">
                Sometimes the performance constraint is upstream — a weak platform, missing
                systems, or unclear positioning. A discovery call will identify whether
                Performance is the right first layer, or whether something else unlocks more
                value faster.
              </p>
            </div>
          </div>
