...
export default function PerfCTA() {
  return (
    <Section bg="primary" id="perf-cta">
      <Container>
        <ScrollReveal variants={scaleIn}>
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated px-8 py-16 text-center sm:px-16 sm:py-20">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg, transparent 0%, rgba(236,72,153,0.6) 30%, rgba(245,158,11,0.6) 70%, transparent 100%)',
              }}
              aria-hidden="true"
            />
            ...
            <div
              ...
              style={{
                ...
                height: '350px',
                background:
                  'radial-gradient(ellipse at center, rgba(236,72,153,0.1) 0%, rgba(245,158,11,0.06) 60%, transparent 80%)',
                filter: 'blur(40px)',
              }}
            />
            ...
            >
              <p className="mb-4 font-mono text-[11px] uppercase tracking-[0.14em] text-text-muted">
                Ready to build the performance layer
              </p>
              ...
              <p className="mx-auto mb-10 max-w-[480px] font-body text-[15px] leading-relaxed text-text-secondary">
                More budget into an inefficient system produces more waste, not more
                revenue. Let&apos;s build the performance architecture first — then scale
