...
export default function BPCTA() {
  return (
    <Section bg="primary" id="bp-cta">
      <Container>
        <ScrollReveal variants={scaleIn}>
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated px-8 py-16 text-center sm:px-16 sm:py-20">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(90deg, transparent 0%, rgba(16,185,129,0.6) 30%, rgba(108,58,255,0.6) 70%, transparent 100%)',
              }}
              aria-hidden="true"
            />
            ...
            <div
              ...
              style={{
                ...
                height: '350px',
                background:
                  'radial-gradient(ellipse at center, rgba(16,185,129,0.1) 0%, rgba(108,58,255,0.08) 55%, transparent 75%)',
                filter: 'blur(40px)',
              }}
            />
            ...
            >
              <p className="mb-4 font-mono text-[11px] uppercase tracking-[0.14em] text-text-muted">
                Ready to build the presence layer
              </p>
              ...
              <p className="mx-auto mb-10 max-w-[480px] font-body text-[15px] leading-relaxed text-text-secondary">
                When positioning is unclear and authority is thin, price becomes the only
                differentiator. Let&apos;s build the presence that makes your value
                self-evident — before the first conversation starts.
              </p>
