...
import { problems } from '@/lib/data/service-pages/brand-presence'

export default function BPProblems() {
  return (
    <Section bg="secondary" id="bp-problems">
      <Container>
        <div className="mb-14 max-w-2xl">
          <ScrollReveal>
            <SectionLabel withLine className="mb-5">
              Where brands start losing value
            </SectionLabel>
          </ScrollReveal>
          <ScrollReveal delay={0.08}>
            <h2 className="font-display text-[clamp(30px,4.5vw,52px)] font-bold leading-[1.1] tracking-[-0.03em] text-text-primary">
              ...
              >
                undersells your capability.
              </span>
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.14}>
            <p className="mt-5 font-body text-[16px] leading-relaxed text-text-secondary">
              Brand problems are rarely visible problems. They show up indirectly — in
              longer sales cycles, lower close rates, price pressure from buyers who
              do not yet understand the value. These are the failure modes we see most
              consistently.
            </p>
          </ScrollReveal>
        </div>
