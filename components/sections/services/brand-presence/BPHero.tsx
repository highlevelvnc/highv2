...
export default function BPHero() {
  return (
    <section
      ...
      aria-label="Brand Presence hero"
    >
      {/* Ambient glow — emerald top-right, faint violet left */}
      <div
        ...
        style={{
          ...
          height: '600px',
          background:
            'radial-gradient(ellipse at right top, rgba(16,185,129,0.1) 0%, rgba(108,58,255,0.05) 55%, transparent 70%)',
          filter: 'blur(60px)',
        }}
      />
      <div
      ...
      <Container>
        <div className="max-w-3xl">
          ...
          <motion.p
            ...
            animate="visible"
          >
            From positioning and content systems to social media, thought leadership, and
            authority assets, we build the presence layer that helps companies be
            understood, remembered, and chosen.
          </motion.p>
